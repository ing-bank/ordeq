...
2   3     20
3   4     -1)
INFO	ordeq.runner	Running node '__main__:check_store_invalid_records'
INFO	ordeq.io	Saving JSON(path=Path('<TEMP_DIR>/invalid_records.json'))
INFO	ordeq.runner	Running view '__main__:process_records'
INFO	ordeq.runner	Running view '__main__:print_processed_records'
INFO	ordeq.runner	Running view '__main__:print_invalid_records'
