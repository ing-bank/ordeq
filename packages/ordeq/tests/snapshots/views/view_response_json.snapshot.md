...
```text
io-1 --> View:view_response_json:to_yaml
io-2 --> View:view_response_json:users_json
View:view_response_json:to_yaml --> io-3
View:view_response_json:users_json --> io-1
