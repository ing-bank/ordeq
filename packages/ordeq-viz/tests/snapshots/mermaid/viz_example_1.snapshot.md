...
graph TB
	...
	unknown_90 --> example_1.pipeline:transform_input
	example_1.pipeline:transform_input --> unknown_91
	unknown_92 --> example_1.pipeline:transform_mock_input
	example_1.pipeline:transform_mock_input --> unknown_93
	...
	unknown_90@{shape: rect, label: "TestInput"}
	unknown_91@{shape: rect, label: "TestOutput"}
	unknown_92@{shape: rect, label: "Hello"}
	unknown_93@{shape: rect, label: "World"}
	...
	class L00,unknown_90 io0
	class L01,unknown_91 io1
	...
	class L05,example_1.nodes:x,example_1.nodes:y,unknown_92,unknown_93 io5
