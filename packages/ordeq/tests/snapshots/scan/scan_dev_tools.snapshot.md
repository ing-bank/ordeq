...
{Node(module=ordeq_dev_tools.pipelines.docs_package_overview, name=write_html_table_by_group, inputs=[IO(id=ID1)], outputs=[TextLinesStream(path=Path('/docs/packages.md'))]): [FQN(module='ordeq_dev_tools.pipelines.docs_package_overview', name='write_html_table_by_group')],
 ...
 View(module=ordeq_dev_tools.pipelines.generate_release_notes, name=commit_hashes, inputs=[IO(id=ID9)]): [FQN(module='ordeq_dev_tools.pipelines.generate_release_notes', name='commit_hashes')],
 View(module=ordeq_dev_tools.pipelines.generate_release_notes, name=latest_version, inputs=[IO(id=ID10)]): [FQN(module='ordeq_dev_tools.pipelines.generate_release_notes', name='latest_version')],
 ...
 View(module=ordeq_dev_tools.pipelines.generate_release_notes, name=commits_since_tag, inputs=[IO(id=ID10)]): [FQN(module='ordeq_dev_tools.pipelines.generate_release_notes', name='commits_since_tag')],
 ...
 View(module=ordeq_dev_tools.pipelines.docs_package_overview, name=groups, inputs=[IO(id=ID12)]): [FQN(module='ordeq_dev_tools.pipelines.docs_package_overview', name='groups')],
 ...
 View(module=ordeq_dev_tools.pipelines.docs_update_just, name=docs_just_section, inputs=[IO(id=ID13)]): [FQN(module='ordeq_dev_tools.pipelines.docs_update_just', name='docs_just_section')],
 ...
 View(module=ordeq_dev_tools.pipelines.generate_release_notes, name=changes, inputs=[IO(id=ID16), IO(id=ID9), IO(id=ID17)]): [FQN(module='ordeq_dev_tools.pipelines.generate_release_notes', name='changes')],
 ...
 View(module=ordeq_dev_tools.pipelines.generate_draft_releases, name=new_releases, inputs=[IO(id=ID12)]): [FQN(module='ordeq_dev_tools.pipelines.generate_draft_releases', name='new_releases')],
 ...
 View(module=ordeq_dev_tools.pipelines.validate_pyproject, name=groups, inputs=[IO(id=ID12)]): [FQN(module='ordeq_dev_tools.pipelines.validate_pyproject', name='groups')]}
IOs:
