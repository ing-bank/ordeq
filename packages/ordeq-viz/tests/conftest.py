...
def expected_example_nodes() -> set[Callable]:
    ...
    """
    from example.nodes import world, node_with_inline_io  # ty: ignore[unresolved-import]
    ...
    """Expected nodes in the example package."""
    return {transform_input, transform_mock_input, world, hello, print_message, node_with_inline_io}
