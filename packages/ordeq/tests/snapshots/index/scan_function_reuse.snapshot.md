...
{<function print_input at HASH1>: (('example_function_reuse.nodes', 'a'),
 ...
 ('example_function_reuse.nodes', 'pi'): (('example_function_reuse.nodes',
                                          ...
                                          <function pi at HASH5>)}
IOs:
{4424166656: (('example_function_reuse.nodes',
               'B'),
              StringBuffer(_buffer=<_io.StringIO object at HASH6>)),
 4424166736: (('example_function_reuse.nodes',
               'A'),
              StringBuffer(_buffer=<_io.StringIO object at HASH7>)),
 4424166816: (('example_function_reuse.catalog',
               'C'),
              StringBuffer(_buffer=<_io.StringIO object at HASH8>)),
 4424166896: (('example_function_reuse.catalog',
               'D'),
              StringBuffer(_buffer=<_io.StringIO object at HASH9>)),
 'example_function_reuse.catalog:A': (('example_function_reuse.catalog',
                                       'A'),
                                      StringBuffer(_buffer=<_io.StringIO object at HASH7>)),
 'example_function_reuse.catalog:B': (('example_function_reuse.catalog',
                                       'B'),
                                      StringBuffer(_buffer=<_io.StringIO object at HASH6>)),
 'example_function_reuse.catalog:C': (('example_function_reuse.catalog',
                                       'C'),
                                      StringBuffer(_buffer=<_io.StringIO object at HASH8>)),
 'example_function_reuse.catalog:D': (('example_function_reuse.catalog',
                                       'D'),
                                      StringBuffer(_buffer=<_io.StringIO object at HASH9>)),
 'example_function_reuse.nodes:A': (('example_function_reuse.nodes',
                                     'A'),
                                    StringBuffer(_buffer=<_io.StringIO object at HASH7>)),
 'example_function_reuse.nodes:B': (('example_function_reuse.nodes',
                                     'B'),
                                    StringBuffer(_buffer=<_io.StringIO object at HASH6>)),
 ('example_function_reuse.catalog', 'A'): (('example_function_reuse.catalog',
                                            'A'),
