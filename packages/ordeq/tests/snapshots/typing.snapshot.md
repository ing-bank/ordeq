packages/ordeq/tests/resources/views/view_takes_node_output.py:3: error: Need type annotation for "placeholder"  [var-annotated]
packages/ordeq/tests/resources/views/view_takes_node_output.py:5: error: Need type annotation for "hello"  [var-annotated]
packages/ordeq/tests/resources/views/view_response_json.py:5: error: Need type annotation for "users_response"  [var-annotated]
packages/ordeq/tests/resources/views/view_response_iter.py:8: error: Need type annotation for "users_response"  [var-annotated]
packages/ordeq/tests/resources/views/view_patch_io.py:3: error: Need type annotation for "hello_io"  [var-annotated]
...
packages/ordeq/tests/resources/runner/runner_exhausted_stream.py:23: error: Need type annotation for "x3"  [var-annotated]
...
packages/ordeq/tests/resources/nodes/node_unexpected_output_type.py:3: error: Need type annotation for "x"  [var-annotated]
packages/ordeq/tests/resources/nodes/node_unexpected_output_type.py:6: error: No overload variant of "node" matches argument types "Input[Any]", "Input[Any]"  [call-overload]
...
packages/ordeq/tests/resources/nodes/node_unexpected_output_type.py:6: note:     def node(*, inputs: Sequence[Input[Any] | Callable[..., Any]] | Input[Any] | Callable[..., Any] = ..., outputs: Sequence[Output[Any]] | Output[Any] | None = ..., checks: Sequence[Input[Any] | Output[Any] | Callable[..., Any]] | Input[Any] | Output[Any] | Callable[..., Any] | None = ..., **attributes: Any) -> Callable[[Callable[FuncParams, FuncReturns]], Node[FuncParams, FuncReturns]]
...
packages/ordeq/tests/resources/views/view_response_stream.py:8: error: Need type annotation for "users_response"  [var-annotated]
...
packages/ordeq/tests/resources/runner/runner_io_more_than_once.py:5: error: Need type annotation for "x1"  [var-annotated]
packages/ordeq/tests/resources/runner/runner_io_more_than_once.py:25: error: Need type annotation for "p1"  [var-annotated]
packages/ordeq/tests/resources/runner/runner_io.py:5: error: Need type annotation for "x1"  [var-annotated]
packages/ordeq/tests/resources/runner/runner_io.py:26: error: Need type annotation for "p1"  [var-annotated]
packages/ordeq/tests/resources/runner/runner_io.py:27: error: Need type annotation for "p3"  [var-annotated]
packages/ordeq/tests/resources/runner/run_node_filter_views.py:4: error: Need type annotation for "greeting"  [var-annotated]
packages/ordeq/tests/resources/runner/run_node_filter_attributes.py:4: error: Need type annotation for "greeting"  [var-annotated]
packages/ordeq/tests/resources/runner/run_node_filter_all.py:4: error: Need type annotation for "greeting"  [var-annotated]
packages/ordeq/tests/resources/runner/run_node_filter.py:4: error: Need type annotation for "greeting"  [var-annotated]
...
packages/ordeq/tests/resources/runner/example_module_b.py:5: error: Need type annotation for "x1"  [var-annotated]
packages/ordeq/tests/resources/runner/example_module_a.py:5: error: Need type annotation for "x1"  [var-annotated]
packages/ordeq/tests/resources/checks/check_impossible.py:4: error: Need type annotation for "hello"  [var-annotated]
packages/ordeq/tests/resources/views/view_train_test_split.py:6: error: Need type annotation for "dataframe"  [var-annotated]
packages/ordeq/tests/resources/views/view_to_pandas.py:13: error: Need type annotation for "csv"  [var-annotated]
packages/ordeq/tests/resources/views/view_df_select.py:4: error: Need type annotation for "dataframe"  [var-annotated]
packages/ordeq/tests/resources/views/view_df_cast.py:4: error: Need type annotation for "dataframe"  [var-annotated]
...
packages/ordeq/tests/resources/views/standalone_view_df_cast.py:4: error: Need type annotation for "dataframe"  [var-annotated]
packages/ordeq/tests/resources/checks/checks_without_input.py:4: error: Need type annotation for "A"  [var-annotated]
packages/ordeq/tests/resources/checks/checks_after_load.py:5: error: Need type annotation for "txs"  [var-annotated]
packages/ordeq/tests/resources/checks/check_store_invalid_records.py:10: error: Need type annotation for "records"  [var-annotated]
packages/ordeq/tests/resources/checks/check_store_invalid_records.py:14: error: Need type annotation for "processed_records"  [var-annotated]
packages/ordeq/tests/resources/checks/check_between_saves.py:7: error: Need type annotation for "txs"  [var-annotated]
packages/ordeq/tests/resources/checks/check_after_save.py:18: error: "Series[Any]" not callable  [operator]
packages/ordeq/tests/resources/checks/check_after_load_inputs_and_checks.py:7: error: Need type annotation for "txs"  [var-annotated]
packages/ordeq/tests/resources/checks/check_after_load_inputs_and_checks.py:16: error: Need type annotation for "threshold"  [var-annotated]
...
Found 65 errors in 48 files (checked 283 source files)
