...
```text
NodeIOGraph
View:example_duplicates.duplicate_node_names:<lambda> --> io-1
View:example_duplicates.duplicate_node_objects:<lambda> --> io-2
Node:example_duplicates.file1:foo --> io-3
Node:example_duplicates.file2:foo --> io-4
io-5 --> Node:example_duplicates.file1:foo
io-6 --> Node:example_duplicates.file2:foo
NodeGraph
View:example_duplicates.duplicate_node_names:<lambda>
View:example_duplicates.duplicate_node_objects:<lambda>
