...
graph TB
	...
	class node_type,example_checks.pipeline_checks_as_nodes:process_b,example_checks.pipeline_checks_as_nodes:process_a,example_checks.pipeline_checks_as_nodes:join node
	class view_type,example_checks.pipeline_checks_as_nodes:check_ab,example_checks.pipeline_checks_as_nodes:check_join,example_checks.pipeline_checks_as_nodes:check_bp,example_checks.pipeline_checks_as_nodes:check_ap,example_checks.pipeline_checks_as_nodes:check_a,example_checks.pipeline_checks_as_nodes:print_result view
...
DEBUG	ordeq.io	Unpersisting data for StringBuffer 'AB' in module 'example_checks.pipeline_checks_as_nodes'
