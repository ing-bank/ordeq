...
DEBUG	ordeq.io	Persisting data for IO 'split:df' in module '__main__'
DEBUG	ordeq.io	Loading cached data for IO 'split:df' in module '__main__'
DEBUG	ordeq.runner	Running view 'split' in module '__main__'
...
DEBUG	ordeq.runner	Running view 'train' in module '__main__'
DEBUG	ordeq.io	Persisting data for IO(id=ID2)
DEBUG	ordeq.io	Unpersisting data for IO 'split:df' in module '__main__'
