...
[(FQN(module='ordeq_dev_tools.pipelines.docs_package_overview', name='packages'),
 ...
 (FQN(module='ordeq_dev_tools.pipelines.docs_package_overview', name='groups'),
  View(func=ordeq_dev_tools.pipelines.docs_package_overview:groups, inputs=[IO(id=ID1)])),
 ...
 (FQN(module='ordeq_dev_tools.pipelines.docs_update_just', name='docs_just_section'),
  View(func=ordeq_dev_tools.pipelines.docs_update_just:docs_just_section, inputs=[IO(id=ID3)])),
 ...
 (FQN(module='ordeq_dev_tools.pipelines.generate_draft_releases', name='new_releases'),
  View(func=ordeq_dev_tools.pipelines.generate_draft_releases:new_releases, inputs=[IO(id=ID1)])),
 (FQN(module='ordeq_dev_tools.pipelines.generate_draft_releases', name='create_releases'),
  View(func=ordeq_dev_tools.pipelines.generate_draft_releases:create_releases, inputs=[IO(id=ID5), IO(id=ID6)])),
 (FQN(module='ordeq_dev_tools.pipelines.generate_release_notes', name='tags'),
  View(func=ordeq_dev_tools.pipelines.generate_release_notes:tags, inputs=[Input(id=ID7)])),
 (FQN(module='ordeq_dev_tools.pipelines.generate_release_notes', name='latest_tag'),
  View(func=ordeq_dev_tools.pipelines.generate_release_notes:latest_tag, inputs=[IO(id=ID8)])),
 (FQN(module='ordeq_dev_tools.pipelines.generate_release_notes', name='latest_version'),
  View(func=ordeq_dev_tools.pipelines.generate_release_notes:latest_version, inputs=[IO(id=ID9)])),
 (FQN(module='ordeq_dev_tools.pipelines.generate_release_notes', name='commits_since_tag'),
  View(func=ordeq_dev_tools.pipelines.generate_release_notes:commits_since_tag, inputs=[IO(id=ID9)])),
 (FQN(module='ordeq_dev_tools.pipelines.generate_release_notes', name='commit_hashes'),
  View(func=ordeq_dev_tools.pipelines.generate_release_notes:commit_hashes, inputs=[IO(id=ID10)])),
 (FQN(module='ordeq_dev_tools.pipelines.generate_release_notes', name='commit_changed_files'),
  View(func=ordeq_dev_tools.pipelines.generate_release_notes:commit_changed_files, inputs=[IO(id=ID11)])),
 (FQN(module='ordeq_dev_tools.pipelines.generate_release_notes', name='relevant_commits'),
  View(func=ordeq_dev_tools.pipelines.generate_release_notes:relevant_commits, inputs=[IO(id=ID11), IO(id=ID12), Input(id=ID7)])),
 (FQN(module='ordeq_dev_tools.pipelines.generate_release_notes', name='relevant_prs'),
  View(func=ordeq_dev_tools.pipelines.generate_release_notes:relevant_prs, inputs=[IO(id=ID13)])),
 (FQN(module='ordeq_dev_tools.pipelines.generate_release_notes', name='distinct_labels'),
  View(func=ordeq_dev_tools.pipelines.generate_release_notes:distinct_labels, inputs=[IO(id=ID14)])),
 (FQN(module='ordeq_dev_tools.pipelines.generate_release_notes', name='bump_type'),
  View(func=ordeq_dev_tools.pipelines.generate_release_notes:bump_type, inputs=[IO(id=ID15)])),
 (FQN(module='ordeq_dev_tools.pipelines.generate_release_notes', name='bump_version'),
  View(func=ordeq_dev_tools.pipelines.generate_release_notes:bump_version, inputs=[IO(id=ID16), IO(id=ID17)])),
 ...
 (FQN(module='ordeq_dev_tools.pipelines.generate_release_notes', name='changes'),
  View(func=ordeq_dev_tools.pipelines.generate_release_notes:changes, inputs=[IO(id=ID13), IO(id=ID10), IO(id=ID14)])),
 ...
 (FQN(module='ordeq_dev_tools.pipelines.validate_pyproject', name='groups'),
  View(func=ordeq_dev_tools.pipelines.validate_pyproject:groups, inputs=[IO(id=ID1)])),
