...
graph TB
	...
	example_nested.subpackage.subsubpackage.hello_relative:world_relative --> IO0
...
```text
UserWarning: 'world_relative' in module 'example_nested.subpackage.subsubpackage.hello_relative' was provided more than once. Duplicates are ignored.
```
