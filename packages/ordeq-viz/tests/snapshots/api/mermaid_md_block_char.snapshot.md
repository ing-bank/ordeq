...
graph TB
	...
	unknown_27 --> example_1.pipeline:transform_input
	example_1.pipeline:transform_input --> unknown_28
	unknown_29 --> example_1.pipeline:transform_mock_input
	example_1.pipeline:transform_mock_input --> unknown_30
	...
	unknown_27@{shape: rect, label: "TestInput"}
	unknown_28@{shape: rect, label: "TestOutput"}
	unknown_29@{shape: rect, label: "Hello"}
	unknown_30@{shape: rect, label: "World"}
	...
	class L00,unknown_27 io0
	class L01,unknown_28 io1
	...
	class L05,example_1.nodes:x,example_1.nodes:y,unknown_29,unknown_30 io5
