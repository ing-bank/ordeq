...
```text
HELLO FROM REMOTE!HEY I AM OVERRIDING THE HELLO IO!HELLO FROM REMOTE!HELLO FROM REMOTE!HEY I AM OVERRIDING THE HELLO IO!HEY I AM OVERRIDING THE HELLO IO!HEY I AM OVERRIDING THE HELLO IO!HEY I AM OVERRIDING THE HELLO IO!HEY I AM OVERRIDING THE HELLO IO!, world!!
...
```text
INFO	ordeq.runner	Running node "uppercase" in module "run_io_mixture"
INFO	ordeq.io	Saving StringBuffer(_buffer=<_io.StringIO object at HASH1>)
INFO	ordeq.runner	Running node "add_world" in module "run_io_mixture"
