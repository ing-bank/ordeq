...
[Node(module=example_1.wrapped_io, name=hello, inputs=[IO(id=ID1)], outputs=[SayHello(name=NameGenerator(name='John'), writer=(NamePrinter(),))]),
 Node(module=example_1.wrapped_io, name=print_message, inputs=[IO(id=ID2)], outputs=[NamePrinter()])]
