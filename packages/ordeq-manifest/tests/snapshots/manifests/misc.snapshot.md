...
```text
packages/ordeq-manifest/tests/resources/manifests/misc.py:2: error: Skipping analyzing "example_project": module is installed, but missing library stubs or py.typed marker  [import-untyped]
