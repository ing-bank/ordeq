...
```text
packages/ordeq-manifest/tests/resources/manifests/nodes_import_reassign.py:2: error: Skipping analyzing "example_project": module is installed, but missing library stubs or py.typed marker  [import-untyped]
