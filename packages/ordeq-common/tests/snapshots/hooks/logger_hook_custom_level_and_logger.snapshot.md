...
ValueError: Intentional failure for testing.
  ...
  File "/packages/ordeq/src/ordeq/_runner.py", line 67, in _run_node
    values = node.func(*args)

  File "/packages/ordeq/src/ordeq/_runner.py", line 71, in _run_node
    raise exc
  ...
  File "/packages/ordeq/src/ordeq/_runner.py", line 185, in run
...
INFO	ordeq.runner	Running node "hello" in "logger_hook_custom_level_and_logger"
...
INFO	ordeq.runner	Running node "fail" in "logger_hook_custom_level_and_logger"
