...
View:example_anonymous.node_with_var_names:add --> io-5
Node:example_anonymous.nodes:node_with_inline_io --> io-6
NodeGraph
Node:example_anonymous.nodes:node_with_inline_io --> Stub:example_anonymous.nodes:node_with_inline_io
View:example_anonymous.node_with_var_names:add --> Stub:example_anonymous.node_with_var_names:add
Topological ordering
(Stub(value=IO(id=ID1)),
 Stub(value=Input(id=ID2)),
