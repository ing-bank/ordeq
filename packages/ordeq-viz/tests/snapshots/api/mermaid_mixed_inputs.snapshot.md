...
graph TB
	...
	unknown_31 --> example_1.pipeline:transform_input
	example_1.pipeline:transform_input --> unknown_32
	unknown_33 --> example_1.pipeline:transform_mock_input
	example_1.pipeline:transform_mock_input --> unknown_34
	...
	unknown_31@{shape: rect, label: "TestInput"}
	unknown_32@{shape: rect, label: "TestOutput"}
	unknown_33@{shape: rect, label: "Hello"}
	unknown_34@{shape: rect, label: "World"}
	...
	class L00,unknown_31 io0
	class L01,unknown_32 io1
	...
	class L05,example_1.nodes:x,example_1.nodes:y,unknown_33,unknown_34 io5
