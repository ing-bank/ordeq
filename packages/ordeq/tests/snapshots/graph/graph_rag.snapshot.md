...
io-2 --> Node:example_rag_pipeline.rag.question_answering:question_answering
io-3 --> Node:example_rag_pipeline.rag.retrieval:retrieve
io-3 --> Node:example_rag_pipeline.rag.indexer:create_vector_index
io-4 --> Node:example_rag_pipeline.rag.retrieval:filter_relevant
...
io-8 --> Node:example_rag_pipeline.rag.policies:generate_questions
io-9 --> Node:example_rag_pipeline.rag.evaluation:evaluate_answers
io-9 --> Node:example_rag_pipeline.rag.annotation:annotate_documents
Node:example_rag_pipeline.rag.retrieval:retrieve --> io-4
Node:example_rag_pipeline.rag.retrieval:filter_relevant --> io-6
Node:example_rag_pipeline.rag.question_answering:question_answering --> io-9
Node:example_rag_pipeline.rag.indexer:create_vector_index --> io-1
Node:example_rag_pipeline.rag.policies:generate_questions --> io-2
