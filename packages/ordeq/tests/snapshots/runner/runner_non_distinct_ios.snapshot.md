...
```text
ValueError: Nodes '__main__:func2' and '__main__:func1' both output to resource StringBuffer(_buffer=<_io.StringIO object at HASH1>). Nodes cannot output to the same resource.
