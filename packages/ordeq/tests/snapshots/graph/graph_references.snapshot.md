...
ImportError: cannot import name 'NamedNodeGraph' from 'ordeq._graph' (/packages/ordeq/src/ordeq/_graph.py)
  File "/packages/ordeq/tests/resources/graph/graph_references.py", line LINO, in <module>
    from ordeq._graph import NamedNodeGraph, NamedNodeIOGraph
...
```text
packages/ordeq/tests/resources/graph/graph_references.py:5:26: error[unresolved-import] Module `ordeq._graph` has no member `NamedNodeGraph`
packages/ordeq/tests/resources/graph/graph_references.py:5:42: error[unresolved-import] Module `ordeq._graph` has no member `NamedNodeIOGraph`
Found 2 diagnostics
