...
DEBUG	ordeq.io	Persisting data for IO 'csv_as_df:data' in module '__main__'
DEBUG	ordeq.io	Loading cached data for IO 'csv_as_df:data' in module '__main__'
DEBUG	ordeq.runner	Running view 'csv_as_df' in module '__main__'
...
DEBUG	ordeq.runner	Running view 'aggregate' in module '__main__'
DEBUG	ordeq.io	Persisting data for IO(id=ID2)
DEBUG	ordeq.io	Unpersisting data for IO 'csv_as_df:data' in module '__main__'
DEBUG	ordeq.io	Unpersisting data for IO 'aggregate:df' in module '__main__'
