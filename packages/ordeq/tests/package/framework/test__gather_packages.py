    ...
    [
        ...
        pytest.param(
            ...
            [
                "index:FaissIndex",
                "llm_answers:IO",
                "llm_model:SentenceTransformer",
                "llm_vision_retrieval_model:SentenceTransformer",
                "metrics:Pickle",
                "pdf_documents:PymupdfFile",
                "pdfs_documents_annotated:PymupdfFile",
                "policies:PandasExcel",
                "questions:IO",
                "relevant_pages:IO",
                "retrieved_pages:IO",
            ],
