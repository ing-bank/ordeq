...
WARNING	ordeq.preview	Checks are in preview mode and may change without notice in future releases.
WARNING	ordeq.preview	Checks are in preview mode and may change without notice in future releases.
INFO	ordeq.runner	Loading Input 'A' in module 'example_checks.pipeline_checks_as_checks'
DEBUG	ordeq.io	Loading cached data for Input 'A' in module 'example_checks.pipeline_checks_as_checks'
INFO	ordeq.runner	Loading Input 'D' in module 'example_checks.pipeline_checks_as_checks'
...
INFO	ordeq.runner	Saving IO 'Ap' in module 'example_checks.pipeline_checks_as_checks'
DEBUG	ordeq.io	Persisting data for IO 'Ap' in module 'example_checks.pipeline_checks_as_checks'
INFO	ordeq.runner	Loading Input 'B' in module 'example_checks.pipeline_checks_as_checks'
...
INFO	ordeq.runner	Saving IO 'Bp' in module 'example_checks.pipeline_checks_as_checks'
DEBUG	ordeq.io	Persisting data for IO 'Bp' in module 'example_checks.pipeline_checks_as_checks'
INFO	ordeq.runner	Loading IO 'Ap' in module 'example_checks.pipeline_checks_as_checks'
...
INFO	ordeq.runner	Loading IO 'Ap' in module 'example_checks.pipeline_checks_as_checks'
DEBUG	ordeq.io	Loading cached data for IO 'Ap' in module 'example_checks.pipeline_checks_as_checks'
INFO	ordeq.runner	Loading IO 'Bp' in module 'example_checks.pipeline_checks_as_checks'
...
INFO	ordeq.runner	Saving StringBuffer 'AB' in module 'example_checks.pipeline_checks_as_checks'
DEBUG	ordeq.io	Persisting data for StringBuffer 'AB' in module 'example_checks.pipeline_checks_as_checks'
INFO	ordeq.runner	Loading StringBuffer 'AB' in module 'example_checks.pipeline_checks_as_checks'
