...
packages/ordeq/tests/resources/graph/graph_duplicates.py:9: error: Name "nodes" is not defined  [name-defined]
...
Found 30 errors in 20 files (checked 216 source files)
