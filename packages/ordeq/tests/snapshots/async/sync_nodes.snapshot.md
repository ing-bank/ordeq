...
```text
DEBUG	ordeq.runner	Running node 'write_buffer_1' in module 'example_async.sync_nodes'
...
DEBUG	ordeq.runner	Running node 'write_buffer_2' in module 'example_async.sync_nodes'
