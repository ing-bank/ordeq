...
View:ordeq_dev_tools.pipelines.generate_api_docs:check_ios_packages --> io-14
View:View(func=ordeq_dev_tools.pipelines.generate_api_docs:clear_api_docs, ...) --> io-15
View:View(func=ordeq_dev_tools.pipelines.docs_update_just:just_output, ...) --> io-16
io-11 --> Node:ordeq_dev_tools.pipelines.list_dependencies:parse_dependencies
...
io-15 --> View:ordeq_dev_tools.pipelines.generate_api_docs:generate_package_docs
io-16 --> View:ordeq_dev_tools.pipelines.docs_update_just:docs_just_section
Node:ordeq_dev_tools.pipelines.list_dependencies:parse_dependencies --> io-17
View:View(func=ordeq_dev_tools.pipelines.list_changed_packages:changed_files, ...) --> io-18
View:ordeq_dev_tools.pipelines.generate_release_notes:changes --> io-19
...
View:ordeq_dev_tools.pipelines.generate_api_docs:generate_package_docs --> io-23
View:ordeq_dev_tools.pipelines.docs_update_just:docs_just_section --> io-24
View:ordeq_dev_tools.pipelines.docs_package_overview:groups --> io-26
io-17 --> Node:ordeq_dev_tools.pipelines.list_dependencies:compute_affected_dependencies
io-17 --> Node:ordeq_dev_tools.pipelines.list_dependencies:generate_mermaid_diagram
io-18 --> Node:ordeq_dev_tools.pipelines.list_changed_packages:extract_changed_packages
io-19 --> Node:ordeq_dev_tools.pipelines.generate_release_notes:create_release_notes
...
io-23 --> View:ordeq_dev_tools.pipelines.generate_api_docs:generate_api_readmes
io-24 --> Node:ordeq_dev_tools.pipelines.docs_update_just:update_docs_with_just_section
io-25 --> Node:ordeq_dev_tools.pipelines.docs_update_just:update_docs_with_just_section
io-26 --> Node:ordeq_dev_tools.pipelines.docs_package_overview:write_html_table_by_group
...
View:ordeq_dev_tools.pipelines.validate_pyproject:groups --> io-29
Node:ordeq_dev_tools.pipelines.list_dependencies:generate_mermaid_diagram --> io-30
Node:ordeq_dev_tools.pipelines.list_dependencies:compute_affected_dependencies --> io-31
Node:ordeq_dev_tools.pipelines.list_changed_packages:extract_changed_packages --> io-32
Node:ordeq_dev_tools.pipelines.generate_release_notes:create_release_notes --> io-33
Node:ordeq_dev_tools.pipelines.generate_release_notes:get_new_tag --> io-34
View:ordeq_dev_tools.pipelines.generate_draft_releases:create_releases --> io-35
View:ordeq_dev_tools.pipelines.generate_api_docs:generate_api_readmes --> io-36
Node:ordeq_dev_tools.pipelines.docs_update_just:update_docs_with_just_section --> io-37
...
(View(module=ordeq_dev_tools.pipelines.generate_release_notes, name=tags, inputs=[Input(id=ID1)]),
 ...
 View(module=ordeq_dev_tools.pipelines.generate_api_docs, name=filter_packages, inputs=[IO(id=ID8)]),
 View(module=ordeq_dev_tools.pipelines.generate_release_notes, name=distinct_labels, inputs=[IO(id=ID9)]),
 ...
 View(module=ordeq_dev_tools.pipelines.generate_api_docs, name=check_ios_packages, inputs=[IO(id=ID10)]),
 View(module=ordeq_dev_tools.pipelines.generate_release_notes, name=latest_version, inputs=[IO(id=ID3)]),
 View(module=ordeq_dev_tools.pipelines.generate_release_notes, name=bump_type, inputs=[IO(id=ID11)]),
 View(module=ordeq_dev_tools.pipelines.docs_package_overview, name=groups, inputs=[IO(id=ID8)]),
 View(module=ordeq_dev_tools.pipelines.docs_update_just, name=docs_just_section, inputs=[IO(id=ID12)]),
 View(module=ordeq_dev_tools.pipelines.generate_api_docs, name=generate_package_docs, inputs=[IO(id=ID13), IO(id=ID14)]),
 View(func=ordeq_dev_tools.pipelines.generate_draft_releases:draft_releases),
 View(module=ordeq_dev_tools.pipelines.generate_draft_releases, name=new_releases, inputs=[IO(id=ID8)]),
 View(module=ordeq_dev_tools.pipelines.generate_release_notes, name=bump_version, inputs=[IO(id=ID15), IO(id=ID16)]),
 ...
 Node(module=ordeq_dev_tools.pipelines.docs_update_just, name=update_docs_with_just_section, inputs=[Text(path=Path('/docs/CONTRIBUTING.md')), IO(id=ID18)], outputs=[Text(path=Path('/docs/CONTRIBUTING.md'))]),
 View(module=ordeq_dev_tools.pipelines.generate_api_docs, name=generate_api_readmes, inputs=[IO(id=ID19)]),
 View(module=ordeq_dev_tools.pipelines.generate_draft_releases, name=create_releases, inputs=[IO(id=ID20), IO(id=ID21)]),
 Node(module=ordeq_dev_tools.pipelines.generate_release_notes, name=get_new_tag, inputs=[Input(id=ID1), IO(id=ID22)], outputs=[IO(id=ID23)]),
 Node(module=ordeq_dev_tools.pipelines.generate_release_notes, name=create_release_notes, inputs=[IO(id=ID24)], outputs=[IO(id=ID25)]),
 Node(module=ordeq_dev_tools.pipelines.list_changed_packages, name=extract_changed_packages, inputs=[IO(id=ID26)], outputs=[JSON(path=Path('/data/dev_tools/changed_packages.json'))]),
 ...
 View(module=ordeq_dev_tools.pipelines.validate_pyproject, name=groups, inputs=[IO(id=ID8)]))
