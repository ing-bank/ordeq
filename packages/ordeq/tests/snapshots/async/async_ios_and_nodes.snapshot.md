...
```text
INFO	ordeq.runner	Running node 'example_async.async_ios_and_nodes:retrieve_data_1'
INFO	ordeq.io	Saving AsyncStringBuffer(_buffer=<_io.StringIO object at HASH2>, sleep_delay=1.0)
INFO	ordeq.runner	Running node 'example_async.async_ios_and_nodes:retrieve_data_2'
INFO	ordeq.io	Saving AsyncStringBuffer(_buffer=<_io.StringIO object at HASH3>, sleep_delay=2.0)
INFO	ordeq.runner	Running node 'example_async.async_ios_and_nodes:process_data'
