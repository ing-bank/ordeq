...
```text
io-0 --> View:__main__:df_filtered
io-1 --> View:__main__:df_filtered
View:__main__:df_filtered --> io-2
...
2    False
Name: B, dtype: bool)
INFO	ordeq.runner	Running view "df_filtered" in module "__main__"
