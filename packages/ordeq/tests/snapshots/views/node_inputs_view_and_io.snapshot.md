...
DEBUG	ordeq.io	Persisting data for IO 'n:name' in module '__main__'
DEBUG	ordeq.runner	Running View(func=__main__:hello, ...)
DEBUG	ordeq.io	Persisting data for IO 'n:greeting' in module '__main__'
DEBUG	ordeq.io	Loading cached data for IO 'n:name' in module '__main__'
...
DEBUG	ordeq.io	Unpersisting data for IO 'n:name' in module '__main__'
