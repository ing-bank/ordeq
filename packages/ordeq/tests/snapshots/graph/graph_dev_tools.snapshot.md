...
View:View(func=ordeq_dev_tools.pipelines.list_changed_packages:changed_files, ...) --> io-15
View:ordeq_dev_tools.pipelines.generate_release_notes:changes --> io-16
View:ordeq_dev_tools.pipelines.generate_release_notes:bump_version --> io-17
View:View(func=ordeq_dev_tools.pipelines.generate_draft_releases:draft_releases, ...) --> io-18
View:ordeq_dev_tools.pipelines.generate_draft_releases:new_releases --> io-19
View:ordeq_dev_tools.pipelines.docs_update_just:docs_just_section --> io-20
View:ordeq_dev_tools.pipelines.docs_package_overview:groups --> io-22
...
io-15 --> Node:ordeq_dev_tools.pipelines.list_changed_packages:extract_changed_packages
io-16 --> Node:ordeq_dev_tools.pipelines.generate_release_notes:create_release_notes
io-17 --> Node:ordeq_dev_tools.pipelines.generate_release_notes:get_new_tag
...
io-20 --> Node:ordeq_dev_tools.pipelines.docs_update_just:update_docs_with_just_section
io-21 --> Node:ordeq_dev_tools.pipelines.docs_update_just:update_docs_with_just_section
io-22 --> Node:ordeq_dev_tools.pipelines.docs_package_overview:write_html_table_by_group
io-23 --> Node:ordeq_dev_tools.pipelines.relevant_packages:extract_relevant_packages
io-24 --> Node:ordeq_dev_tools.pipelines.relevant_packages:extract_relevant_packages
View:ordeq_dev_tools.pipelines.validate_pyproject:groups --> io-25
Node:ordeq_dev_tools.pipelines.list_dependencies:generate_mermaid_diagram --> io-26
Node:ordeq_dev_tools.pipelines.list_dependencies:compute_affected_dependencies --> io-27
Node:ordeq_dev_tools.pipelines.list_changed_packages:extract_changed_packages --> io-28
Node:ordeq_dev_tools.pipelines.generate_release_notes:create_release_notes --> io-29
Node:ordeq_dev_tools.pipelines.generate_release_notes:get_new_tag --> io-30
View:ordeq_dev_tools.pipelines.generate_draft_releases:create_releases --> io-31
Node:ordeq_dev_tools.pipelines.docs_update_just:update_docs_with_just_section --> io-32
Node:ordeq_dev_tools.pipelines.docs_package_overview:write_html_table_by_group --> io-33
Node:ordeq_dev_tools.pipelines.viz_self:visualize_ordeq_dev_tools --> io-34
Node:ordeq_dev_tools.pipelines.relevant_packages:extract_relevant_packages --> io-35
NodeGraph
...
(View(module=ordeq_dev_tools.pipelines.generate_release_notes, name=tags, inputs=[Input(id=ID1)]),
 ...
 Node(module=ordeq_dev_tools.pipelines.docs_package_overview, name=write_html_table_by_group, inputs=[IO(id=ID14)], outputs=[TextLinesStream(path=Path('/docs/packages.md'))]),
 Node(module=ordeq_dev_tools.pipelines.docs_update_just, name=update_docs_with_just_section, inputs=[Text(path=Path('/docs/CONTRIBUTING.md')), IO(id=ID15)], outputs=[Text(path=Path('/docs/CONTRIBUTING.md'))]),
 View(module=ordeq_dev_tools.pipelines.generate_draft_releases, name=create_releases, inputs=[IO(id=ID16), IO(id=ID17)]),
 Node(module=ordeq_dev_tools.pipelines.generate_release_notes, name=get_new_tag, inputs=[Input(id=ID1), IO(id=ID18)], outputs=[IO(id=ID19)]),
