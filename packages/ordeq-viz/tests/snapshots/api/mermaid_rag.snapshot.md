...
graph TB
	...
	IO5@{shape: rect, label: "retrieved_pages"}
	...
	IO0@{shape: rect, label: "pdf_documents"}
	IO1@{shape: rect, label: "llm_vision_retrieval_model"}
	IO10@{shape: rect, label: "pdfs_documents_annotated"}
	IO2@{shape: rect, label: "index"}
	IO3@{shape: rect, label: "policies"}
	IO4@{shape: rect, label: "questions"}
	IO6@{shape: rect, label: "llm_model"}
	IO7@{shape: rect, label: "relevant_pages"}
	IO8@{shape: rect, label: "llm_answers"}
	IO9@{shape: rect, label: "metrics"}
